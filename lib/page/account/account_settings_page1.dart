...
class AccountSettingsPage1 extends StatefulWidget {
  final bool home;
  const AccountSettingsPage1({Key? key,required this.home}) : super(key: key);

  @override
  State<AccountSettingsPage1> createState() => _AccountSettingsPageState();
}

class _AccountSettingsPageState extends State<AccountSettingsPage1> {
  int toggle=0;
  var tap;
  bool isTap=false;
  bool toolTip=false;
  final controller=Get.put(AccountController1());
